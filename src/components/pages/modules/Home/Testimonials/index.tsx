"use client";
import {  getAllIdeasForAll } from "@/lib/api/ideas/action";
...
export function Testimonials() {
  ...
  useEffect(() => {
    const fetchTopIdeas = async () => {
      try {
        setIsLoading(true);
        const ideas = await getAllIdeasForAll(undefined,{
          isPublished: true,
          sortBy: "newest",
        });
            ...
            {topIdeas.map((idea) => (
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="font-medium">{idea.votes.UP_VOTE || 0} votes</span>
                </div>
